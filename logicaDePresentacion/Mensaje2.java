...
public class Mensaje2 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Mensaje2(JFrame ventanaAnterior, Mensajeria correo) {
		...
		JLabel lblSeDebeAadir = new JLabel("Se debe a\u00F1adir el producto MIGUELITO.");
		lblSeDebeAadir.setBounds(15, 123, 316, 20);
		...
		JLabel lblPoseemosUnidades = new JLabel("Poseemos 10 unidades iniciales.");
